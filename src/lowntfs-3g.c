...
nodata :
	...
	stbuf->st_atime = ntfs2timespec(ni->last_access_time).tv_sec;
	stbuf->st_ctime = ntfs2timespec(ni->last_mft_change_time).tv_sec;
	stbuf->st_mtime = ntfs2timespec(ni->last_data_change_time).tv_sec;
